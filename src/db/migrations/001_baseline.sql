...
CREATE TABLE "rounds" (
    ...
    checkin_cleared INTEGER NOT NULL DEFAULT 0,  -- 1 once no call is owed: the check-in cleanup has run (#425),
                                                 -- or a restart gave up a call whose deadline had passed (#429)
