...
- "Principal division" defined in core, which every ban served upon a licence needs — issue #278. The steward spec defines it in its own Concepts until core carries it.
