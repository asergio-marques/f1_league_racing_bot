...
# `src/leaguebot/core/services/scheduler_service.py`, its jobs, its three triggers and its job store. A use
# this does not describe is a type error, not a silent `Any`: extend the stub, don't silence
# the call. `tests/repository/test_library_stubs.py` holds it to the installed APScheduler.
