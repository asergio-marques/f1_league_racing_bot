...
Running them here, rather than as a CI step of their own, means the ordinary test run checks
them on every host (decided with the plan for #282).

import-linter reads the import statements of `src/` without running them, and counts an import
