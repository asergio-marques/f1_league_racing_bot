...
const builder = (o = {}) => ({ onBranch: true, commits: [{ sha: 'c1', subject: 'added a test' }], planComplete: true, remaining: [], tests: [{ nodeid: 'tests/x/test_a.py::test_a', change: 'added', scenario: 's', expects: 'e' }], support: [], testChanges: [], fixed: [], disputed: [], questions: [], blocked: false, clean: true, separateDefects: [], notes: [], ...o })
...
const suite = (o = {}) => ({ exitCode: 0, summary: '9000 passed', failures: [], mypyClean: true, mypyErrors: [], xfailMarkersLeft: 0, uncommitted: [], tmpFree: '700M', environmentProblem: '', log: '/tmp/x.log', changes: changes(), changesError: '', ...o })
