...
not. `src/leaguebot/__main__.py` reads `BOT_TOKEN` at import time, so `tests/conftest.py` gives it a
...
(2026-09-16); `tests/repository/test_suite_needs_no_dotenv.py` pins it.
