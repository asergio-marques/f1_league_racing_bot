...
- Outcome list - A standardized penalty table item, which draws a relationship from a "standard penalty description/case" to a "standard penalty" which may be composed of 1 or more direct outcomes for a verdict of any ticket type. Each outcome has a unique ID string, which is to be used when voting, and an identifying shorthand.
...
- <NEW COMMAND> A "steward conduct-outcome add" command will be made available to league managers... <<< --- TBD --- >>>
- <NEW COMMAND> A "steward conduct-outcome modify" command will be made available to league managers... <<< --- TBD --- >>>
- <NEW COMMAND> A "steward conduct-outcome remove" command will be made available to league managers... <<< --- TBD --- >>>
