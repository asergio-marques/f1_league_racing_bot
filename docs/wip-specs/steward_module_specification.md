...
- Championship points deduction - A possible direct outcome of a verdict for a report or appeal. A number of points is taken from the driver's total in the division's drivers' championship, their results left untouched; the points their team scored in the constructors' championship are kept.
- Championship disqualification - A possible direct outcome of a verdict for a report or appeal. The driver is removed from the division's drivers' championship for the season, their results left untouched, and they may race on unless also banned; the points their team scored in the constructors' championship are kept.
- Constructors' points deduction - A possible direct outcome of a verdict for a report or appeal, given to a team. A number of points is taken from the team's total in the division's constructors' championship; the points its drivers scored in the drivers' championship are kept.
- Constructors' championship disqualification - A possible direct outcome of a verdict for a report or appeal, given to a team. The team is removed from the division's constructors' championship for the season; the points its drivers scored in the drivers' championship are kept.
...
### Deliberation
- A team may be sanctioned upon a ticket only where every full-time driver of that team in the division is an involved driver of it, so that it is represented, and defended, by all of them. Reserve drivers are not counted. The stewards may bring a missing team-mate into the ticket with "Add driver" before deliberation begins.
