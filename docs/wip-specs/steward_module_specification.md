...
- [STW-CON-001] Driver licence - An individual record held by each driver profile of the driver's standing in the league. On it are recorded the driver's warning points, penalty points and discipline points, each with its active status and date, and the driver's bans, as follows:
  ...
  - [STW-CON-009] Where two driver profiles are merged, as the core specification allows, their licences shall be merged into one, so that no sanction is escaped by holding it under another profile:
    ...
    - [STW-CON-014] An auto-rule threshold crossed on either licence shall be held as crossed on the merged one, so that the merge itself punishes nothing already punished. The merged licence shall be checked against the auto-rules at the next cycle close, as any licence is.
...
- [STW-CON-040] Principal division - The highest tier division (the lowest tier number) in which a driver holds a full-time seat. A full-time driver of a tier 2 division who is a reserve driver in tier 1 has tier 2 as their principal division. A driver who is a reserve driver alone, or who holds no seat, has no principal division.
...
- [STW-CON-046] A ticket's channel - The channel the bot creates for a single ticket, in which its defence and deliberation take place. It may be called the report's, the appeal's or the investigation's channel where the kind of ticket matters.
...
- [STW-SET-007] An outcome may not be modified, removed or paused while any report or appeal deliberation is open.
...
- [STW-SET-010] A penalty type that any outcome or conduct outcome uses may not be switched off while any deliberation is open, as set out under "steward penalty toggle".
