...
- Found on 2026-09-04 while investigating a separate report, and never reached a running bot: it was introduced and fixed the same week, by and after the 2026-09-03 change that stops the wizard deleting a seated mock roster.
